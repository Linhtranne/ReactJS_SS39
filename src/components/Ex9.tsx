  ...
  return (
    <div className="bg-blue-600 flex">
      ...
      >
        ...
        >
          ...
          <div className="flex justify-between w-full items-center">
            ...
            <span className={`text-sm rotate-${isDropdownOpen ? '0' : '180'}`} id="arrow">
      ...
      <span
        ...
        onClick={handleSidebarToggle}
      >
        <i className="bi bi-filter-left px-2 bg-gray-900 rounded-md">sidebar</i>
      </span>

      <div className="flex-grow p-4 lg:ml-[300px]">
      </div>
    </div>
  );
}
